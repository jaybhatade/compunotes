      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {notes.map((note) => (
          <Link
            ...
            className="block"
          >
            <div className="bg-gray-800 shadow-md rounded-lg p-4 hover:bg-gray-700 transition duration-300 transform hover:scale-105">
              <div className="flex items-center mb-2">
                <FaBook className="text-blue-400 mr-3 " />
